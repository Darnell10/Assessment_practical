package com.example.d.assessment_practical;
...
import com.example.d.assessment_practical.presentation.CardsRvAdapter;
import com.example.d.assessment_practical.service.CardServiceApi;
...
import static com.example.d.assessment_practical.service.CardServiceApi.BASE_URL;
...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(R.id.remaining_cards_textview)
    TextView remainingcards;

    @BindView(R.id.draw_cards_number)
    EditText draw_cards;

    @BindView(R.id.shuffle_cards_button)
    Button shuffle;
        ...
        draw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cardsPicked < 1) {
                    ...
                    draw_cards.setError(getString(R.string.Error_2) + cardsLeft + getString(R.string.In_deck));
                } else {
